package dev.mruniverse.guardiankitpvp.netherboard;

import dev.mruniverse.guardiankitpvp.netherboard.api.PlayerBoard;
import dev.mruniverse.guardiankitpvp.netherboard.util.NMS;
...
public class BPlayerBoard implements PlayerBoard<String, Integer, String> {
    ...
    public BPlayerBoard(Player player, Scoreboard scoreboard, String name) {
        ...
        if(this.scoreboard == null) {
            ...
            if(sb == Objects.requireNonNull(Bukkit.getScoreboardManager()).getMainScoreboard())
